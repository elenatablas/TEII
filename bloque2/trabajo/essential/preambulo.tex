...
%
	...
	breaklines=true,
%
	morecomment=[f][\color{gray45}][4]{@@},
  	morecomment=[f][\color{verdeOscuro}][2]{+\ },
  	morecomment=[f][\color{rojoOscuro}][2]{-\ },
}
...
{
	basicstyle=\footnotesize\color{gray97},
	backgroundcolor=\color{black},
}
% Código en lenguaje YAML
